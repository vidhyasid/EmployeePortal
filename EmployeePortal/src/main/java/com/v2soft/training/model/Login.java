...
public class Login implements java.io.Serializable {
	...
	public Login(LoginId id, Employee employeeinfo, String password) {
		this.id = id;
		this.employeeinfo = employeeinfo;
		this.password = password;
	}

	public Login(LoginId id, Employee employeeinfo, String password, Set<LoginSession> loginSessions) {
		this.id = id;
		this.employeeinfo = employeeinfo;
		this.password = password;
