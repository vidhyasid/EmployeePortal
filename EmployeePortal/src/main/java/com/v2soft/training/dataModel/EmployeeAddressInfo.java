 ...
 */
public class EmployeeAddressInfo implements java.io.Serializable {

	private EmployeeAddressIdInfo id;
	private AddressTypeInfo addressType;
	...
	public EmployeeAddressInfo(EmployeeAddressIdInfo id, AddressTypeInfo addressType, EmployeeInfo employeeInfo,
	...
	public EmployeeAddressIdInfo getId() {
		return this.id;
	}

	public void setId(EmployeeAddressIdInfo id) {
		this.id = id;
	}

	public AddressTypeInfo getAddressType() {
		return this.addressType;
	}

	public void setAddressType(AddressTypeInfo addressType) {
		this.addressType = addressType;
	}
