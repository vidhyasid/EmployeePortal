 ...
 */
public class LoginIdInfo implements java.io.Serializable {
	...
	public LoginIdInfo(String userName, String employeeId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LoginIdInfo))
			return false;
		LoginIdInfo castOther = (LoginIdInfo) other;
